    ...
    <form action="{{ asset('/admin/product/update') }}/{{ $record ->id }}" method="post">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="url" class="form-control" id="inputEmail4" name="img" required value="{{ $record ->img }}">
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control" id="inputPassword4" name="price" required value="{{ $record ->price }}">
          </div>
        </div>
        <div class="form-group">
          <label for="inputAddress">產品折扣</label>
          <input type="number" class="form-control" id="inputAddress" name="discount" required value="{{ $record ->discount }}" min="0.1" max="1" step="0.01" title="請填入介於0.1~1之間的折扣數字">
        </div>
        <div class="form-group">
            <label for="content">產品描述</label>
            <textarea class="form-control" id="content" rows="3" name="discript" required >{{ $record ->discript }}</textarea>
          </div>
